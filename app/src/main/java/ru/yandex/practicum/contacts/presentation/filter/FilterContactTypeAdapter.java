...
public class FilterContactTypeAdapter extends RecyclerView.Adapter<FilterContactTypeAdapter.ViewHolder> {//отвечает за список типов контактов, по которым можно отфильтровать контакты:
